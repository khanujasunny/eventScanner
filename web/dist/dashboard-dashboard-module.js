...
/* harmony import */ var _shared_services_EventScannerService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/services/EventScannerService */ "./src/app/shared/services/EventScannerService.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(eventScannerService) {
        var _this = this;
        this.eventScannerService = eventScannerService;
        this.alerts = [];
        this.sliders = [];
        this.sliders.push({
        ...
        this.eventScannerService.getEvents().subscribe(function (events) {
            _this.events = events;
        });
        this.eventScannerService.getUsers().subscribe(function (users) {
            _this.users = users;
        });
        this.eventScannerService.getProjects().subscribe(function (projects) {
            _this.projects = projects;
        });
        setInterval(function () {
            _this.eventScannerService.getEvents().subscribe(function (events) {
                _this.events = events;
            });
        }, 3000);
    }
    ...
    DashboardComponent.prototype.getName = function (sid) {
        var returnData;
    ...
    DashboardComponent.prototype.getProject = function (code) {
        var returnData;
    ...
    DashboardComponent.prototype.clearEvents = function () {
        this.eventScannerService.clearEvents().subscribe(function (projects) {
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_EventScannerService__WEBPACK_IMPORTED_MODULE_2__["EventScannerService"]])
    ], DashboardComponent);
...
/* harmony import */ var _shared_services_EventScannerService__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../shared/services/EventScannerService */ "./src/app/shared/services/EventScannerService.ts");
...
var DashboardModule = /** @class */ (function () {
    ...
    DashboardModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_shared_services_EventScannerService__WEBPACK_IMPORTED_MODULE_7__["EventScannerService"]],
        })
    ], DashboardModule);
...
/***/ "./src/app/shared/services/EventScannerService.ts":
/*!********************************************************!*\
  !*** ./src/app/shared/services/EventScannerService.ts ***!
  \********************************************************/
/*! exports provided: EventScannerService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventScannerService", function() { return EventScannerService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
