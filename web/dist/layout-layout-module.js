...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'projects', loadChildren: './dashboard/dashboard.module#DashboardModule' },
            { path: 'timeline', loadChildren: './timeline/timeline.module#TimelineModule' },
            { path: 'addDevice', loadChildren: './dashboard/dashboard.module#DashboardModule' },
            { path: 'manageDevice', loadChildren: './dashboard/dashboard.module#DashboardModule' },
